...
OhdsiRTools::checkUsagePackage("oxfordKneeValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/oxfordKneeValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/oxfordKneeValidation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("oxfordKneeValidation")
