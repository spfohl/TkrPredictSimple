...
#' @param predictTkrSimple   Run the model that predicts 90 day risk of mortality following TKR
...
library(dplyr)
  ...
  studyAnalyses <- getSettings(predictTkrSimple = predictTkrSimple,
                               usePackageCohorts = usePackageCohorts)
